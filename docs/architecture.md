...
**As of 29 August 2026** · shipped tip **v2.4.0** (`versionCode` 260)
...
|--------|----------------|-------|-------------------------------|
| `production` | `com.resurrection.blowtorch2` | BlowTorch 2 | `2.4.0` |
| `btTest` | `com.resurrection.blowtorch2.test` | BlowTorch 2 Test | `2.4.0-test` |

Both share `versionCode` **260**. Typical variants: `productionDebug`,
