...
**As of 14 September 2026** · shipped tip **v2.4.5** (`versionCode` 265)
...
|--------|----------------|-------|-------------------------------|
| `production` | `com.resurrection.blowtorch2` | BlowTorch 2 | `2.4.5` |
| `btTest` | `com.resurrection.blowtorch2.test` | BlowTorch 2 Test | `2.4.5-test` |

Both share `versionCode` **265**. Typical variants: `productionDebug`,
