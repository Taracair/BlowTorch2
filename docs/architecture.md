...
**As of 5 September 2026** · shipped tip **v2.4.3** (`versionCode` 263)
...
|--------|----------------|-------|-------------------------------|
| `production` | `com.resurrection.blowtorch2` | BlowTorch 2 | `2.4.3` |
| `btTest` | `com.resurrection.blowtorch2.test` | BlowTorch 2 Test | `2.4.3-test` |

Both share `versionCode` **263**. Typical variants: `productionDebug`,
