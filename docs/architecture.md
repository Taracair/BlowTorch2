...
**As of 11 September 2026** · shipped tip **v2.4.4** (`versionCode` 264)
...
|--------|----------------|-------|-------------------------------|
| `production` | `com.resurrection.blowtorch2` | BlowTorch 2 | `2.4.4` |
| `btTest` | `com.resurrection.blowtorch2.test` | BlowTorch 2 Test | `2.4.4-test` |

Both share `versionCode` **264**. Typical variants: `productionDebug`,
