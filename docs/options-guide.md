...
- **Pick loupe:** `.pick loupe` prints size and zoom. `.pick loupe size N` (50–200, default 118) and `.pick loupe zoom N` (150–350, 200 = 2×). Also Options → Window. During `.pick hold`, a second finger cancels that pick so you can scroll (two fingers with pick off still copy).
