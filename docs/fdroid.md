...
| Path | Purpose |
|------|---------|
| `fastlane/metadata/android/en-US/` | Title, short/full description, changelog, icon. Phone screenshots must be dummy-host shots on the tag you submit. English only for now; F-Droid falls back here for other languages. |
