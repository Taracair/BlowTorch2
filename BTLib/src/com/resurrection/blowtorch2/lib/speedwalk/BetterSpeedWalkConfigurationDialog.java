...
import com.resurrection.blowtorch2.lib.window.BetterPluginSelectionDialog;
import com.resurrection.blowtorch2.lib.window.StandardSelectionDialog;
...
public class BetterSpeedWalkConfigurationDialog extends StandardSelectionDialog implements BaseSelectionDialog.UtilityToolbarListener,DirectionEditorDoneListener {
	...
	public BetterSpeedWalkConfigurationDialog(Context context,
		...
		this.addToolbarButton(R.drawable.ic_row_edit,0);
		this.addToolbarDeleteButton(R.drawable.ic_row_delete,1);
